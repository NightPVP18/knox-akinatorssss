...
class Base extends Emitter {
    constructor(filter, options = {}) {
        ...
        this.filter = filter;//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
    ...
    setTimeout(fn, delay, ...args) {
        ...
        }, delay);//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
    ...
    get next() {
        return new Promise((resolve, reject) => {
            ...
            const cleanup = () => {
                ...
                this.removeListener("end", onEnd);//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
            };
    ...
    stop(reason = "user") {
        ...
        if (this._timeout) {
            this.clearTimeout(this._timeout);//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
            this._timeout = null;
        }
        if (this._idletimeout) {
            this.clearTimeout(this._idletimeout);
    ...
    async *[Symbol.asyncIterator]() {
        const queue = [];//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
    ...
    collect() {}
    dispose() {}
    endReason() {}//Altyapı yDarKDayS a Aittir !!! https://www.youtube.com/c/yDarKDayS
}
